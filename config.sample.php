<?php
// config.sample.php
// Шаблон настроек для репозитория.
// Скопируйте в config.php и заполните секреты.
// В репозиторий коммитим ТОЛЬКО этот файл.
// ВАЖНО: этот файл можно коммитить. Секреты заменены на плейсхолдеры.
